...
### Output:
- [Power BI Dashboard]([https://github.com/San13deep/Play-Store-App-Review-Analysis/blob/main/Play_Store_App_Review_Analysis_Capstone_Project.ipynb](https://drive.google.com/file/d/1tIwzbwm3bGKhmmGskf8-OrGAfepcW-Oc/view?usp=sharing)) 
...
1. Which app categories have the highest number of applications on the Play Store?

2. How are app ratings distributed across all applications?

3. Which categories receive the highest average ratings?

4. What is the proportion of Free vs Paid apps on the Play Store?

5. What is the total reviews for each category ?

6. What is the distribution of Content Rating categories (Everyone, Teen, Mature, etc.)?

7. How has the number of app updates changed over the years?

8. How has average rating changed over time?

9. What is the relationship between app size and installs?

10. What is the relationship between price and rating?

11. How do ratings differ between Free and Paid apps?

12. How do ratings vary across top 10 categories?

13. What is the distribution of app sizes across the Play Store?

14. What are the pairwise relationships between installs, reviews, price, size, and rating?

15. What is the correlation between numeric variables such as installs, reviews, price, size, and rating?
...
*	Percentage of free apps ≈ 92.6%, indicating strong dominance of free app model.
*	Percentage of paid apps ≈ 7.4%, showing limited adoption of upfront pricing strategy.
*	Most competitive category based on number of apps: Family.
*	Category with the highest total installs: Communication.
*	Categories generating highest user engagement (reviews): Game, Communication, Social.
*	Installs and reviews show a moderate positive correlation (≈ 0.63).
*	Rating has very weak correlation with price, size, and installs.
*	Average app ratings have generally improved over the years, peaking around 2018.
*	Most apps have ratings between 4.0 and 4.5, showing overall high user satisfaction.
*	Rating distribution is left-skewed, meaning fewer apps have low ratings.
*	Paid apps have a slightly higher median rating, but the difference is minimal.
*	Most apps are designed for “Everyone” content rating, indicating broad audience targeting.
*	Most apps are below 50 MB in size, suggesting developers optimize for storage efficiency.
*	App size does not show a strong impact on installs or ratings.
* Popularity (installs) does not necessarily guarantee higher ratings.
